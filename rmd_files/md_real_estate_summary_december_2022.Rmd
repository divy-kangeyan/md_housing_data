---
title: "MD Real Estate Summary December 2022"
...
```{r cars}
december_housing <- read.xls("/Users/Divy/Documents/md_housing_data/excel_files/December 2022 Housing Stats.xlsx", header = TRUE, skip = 1)
...
colnames(december_housing) <- table_column_names
...
reformatted_december_housing <- reformat_housing_df(december_housing)
reformatted_december_housing$month <- "December"

maryland_fips_table <- reformatted_december_housing %>% 
...
reformatted_december_housing$units_sold_change <- (reformatted_december_housing$units_sold_2022 - reformatted_december_housing$units_sold_2021) /
  reformatted_december_housing$units_sold_2021 *100
reformatted_december_housing$units_sold_change_color <- "green"
reformatted_december_housing$units_sold_change_color[reformatted_december_housing$units_sold_change < 0] <- "red"

reformatted_december_housing$just_county_name <- gsub(' County','',reformatted_december_housing$county_name)



ggplot(aes(x = reorder(just_county_name, units_sold_change), y = units_sold_change,
           fill = units_sold_change_color), 
       data = reformatted_december_housing) + 
...
reformatted_december_housing$units_pending_change <- (reformatted_december_housing$units_pending_2022 - reformatted_december_housing$units_pending_2021) /
  reformatted_december_housing$units_pending_2021 *100
reformatted_december_housing$units_pending_change_color <- "green"
reformatted_december_housing$units_pending_change_color[reformatted_december_housing$units_pending_change < 0] <- "red"
...
```{r}
reformatted_december_housing$active_inventory_change <- (reformatted_december_housing$active_inventory_2022 - reformatted_december_housing$active_inventory_2021) /
  reformatted_december_housing$active_inventory_2021 *100
reformatted_december_housing$active_inventory_change_color <- "green"
reformatted_december_housing$active_inventory_change_color[reformatted_december_housing$active_inventory_change < 0] <- "red"
...
reformatted_december_housing$average_sale_price_change <- (reformatted_december_housing$average_sale_price_2022 - reformatted_december_housing$average_sale_price_2021) /
  reformatted_december_housing$average_sale_price_2021 *100
reformatted_december_housing$average_sale_price_change_color <- "green"
reformatted_december_housing$average_sale_price_change_color[reformatted_december_housing$average_sale_price_change < 0] <- "red"
...
```{r}
reformatted_december_housing$median_sale_price_change <- (reformatted_december_housing$median_sale_price_2022 - reformatted_december_housing$median_sale_price_2021) /
  reformatted_december_housing$median_sale_price_2021 *100
reformatted_december_housing$median_sale_price_change_color <- "green"
reformatted_december_housing$median_sale_price_change_color[reformatted_december_housing$median_sale_price_change < 0] <- "red"
...
reformatted_december_housing$median_dom_change <- (reformatted_december_housing$median_dom_2022 - reformatted_december_housing$median_dom_2021) 
reformatted_december_housing$median_dom_change_color <- "green"
reformatted_december_housing$median_dom_change_color[reformatted_december_housing$median_dom_change < 0] <- "red"
...
```{r}
reformatted_december_housing$months_of_inventory_change <- ((reformatted_december_housing$months_of_inventory_2022 - reformatted_december_housing$months_of_inventory_2021) / reformatted_december_housing$months_of_inventory_2021) * 100
reformatted_december_housing$months_of_inventory_change_color <- "green"
reformatted_december_housing$months_of_inventory_change_color[reformatted_december_housing$months_of_inventory_change < 0] <- "red"
...
```{r}
reformatted_december_housing$new_listings_change <- ((reformatted_december_housing$new_listings_2022 - reformatted_december_housing$new_listings_2021) / reformatted_december_housing$new_listings_2021) * 100
reformatted_december_housing$new_listings_change_color <- "green"
reformatted_december_housing$new_listings_change_color[reformatted_december_housing$new_listings_change < 0] <- "red"
...
- Units sold is down in every county except for Allegany county
  - Range of % YoY Change in Units sold is -63% to 3.17%
- Pending Sales is down in every county except for Allegany county
  - Range of % YoY Change in Units pending  is -53% to -8.69%
- Active Inventory is up in 7/24 regions and unchanged in 2 regions
  - Range of % YoY Change in Active Inventory is -34.1% to 24.6%
- Average sale price is down in 13/24 regions 
  - Range of % YoY Change in Average Sale Price is -58% to 10.5%
- Median sale price is down in 13/24 regions and unchanged in one region
  - Range of % YoY Change in Median Sale Price is -24.8% to 10%
- Median days on market is down in 2/24 regions and Median DOM is up in 21/24 region. 
  - In Allegany county YoY median DOM decreased by 7 days and in Caroline county it increased by 28 days  
- Months of inventory is up in 17 counties and unchanged in 4 counties. In rest of the regions months of inventory is down.
  - Range of % YoY Change in Months of Inventory is -28% to 73.7%
- New Listings is up in Kent county and unchanged in Talbot and Carrol counties. Except for that new listings are down in all other counties
  - Range of % YoY Change in New Listings is -61.9% to 47.06%
  
```{r, fig.width=25, fig.height=15}

reformatted_december_housing$county <- reformatted_december_housing$county_name
melted_moco_december_df <- melt(reformatted_december_housing, id.vars = c("county", "month"))

melted_moco_december_df$year <- 0
melted_moco_december_df$year[grep('2021', melted_moco_december_df$variable)] <- 2021
melted_moco_december_df$year[grep('2022',melted_moco_december_df$variable)] <- 2022

melted_moco_december_df <- melted_moco_december_df[melted_moco_december_df$county == "Montgomery County",]

melted_moco_df_jan_november <- read.table("/Users/Divy/Documents/md_housing_data/tsv_files/reformatted_jan_november_2022.tsv",
                                       sep = "\t", header = TRUE)

melted_moco_df_jan_december <- rbind(melted_moco_december_df, melted_moco_df_jan_november)

write.table(melted_moco_df_jan_december, "/Users/Divy/Documents/md_housing_data/tsv_files/reformatted_jan_december_2022.tsv", 
            sep = '\t', row.names = FALSE)

```


## Montgomery County trend: January - November 2022


### Units Sold

```{r}
melted_moco_df_units_sold <- melted_moco_df_jan_december[grep('units_sold_[0-9]', melted_moco_df_jan_december$variable),]
...
melted_moco_df_units_pending <- melted_moco_df_jan_december[grep('units_pending_[0-9]',melted_moco_df_jan_december$variable),]
...
melted_moco_df_active_inventory <- melted_moco_df_jan_december[grep('active_inventory_[0-9]',melted_moco_df_jan_december$variable),]
...
melted_moco_df_average_sale_price <- melted_moco_df_jan_december[grep('average_sale_price_[0-9]',melted_moco_df_jan_december$variable),]
...
melted_moco_df_median_sale_price <- melted_moco_df_jan_december[grep('median_sale_price_[0-9]',melted_moco_df_jan_december$variable),]
...
```{r}
melted_moco_df_median_dom <- melted_moco_df_jan_december[grep('median_dom_[0-9]',melted_moco_df_jan_december$variable),]
...
```{r}
melted_moco_df_months_of_inventory <- melted_moco_df_jan_december[grep('months_of_inventory_[0-9]',melted_moco_df_jan_december$variable),]
...
```{r}
melted_moco_df_new_listings <- melted_moco_df_jan_december[grep('new_listings_[0-9]',melted_moco_df_jan_december$variable),]
...
- Units sold is down from January through December 
  - December showed the largest decline in units sold at -47.36%. Units sold has been negative throughout
  the year with declines above 20% since June
  
- Units pending is also down from January through December with December showing slight improvement from November. Since February YoY decline in units pending has been increasing.

- 2022 active inventory is also down compared to 2021 levels. December decrease was the lowest since January 2022.
-	However, it improved every single month from January 2022 till June 2022. but July there was a slight decline compared to June
  - In January the YoY % difference was -50% but in December the YoY % difference was -8.19%
  
- Average sale price was lower in January 2022 compared to January 2021. 
  - Average sale price declined by $105,959 from May to December 2022. December average prices were below the average prices of March 2022.
  - Average sale price is higher in 2022 compared to 2021. In November YoY increase was 4.96%.

- Median sale price gradually increased every single month since February 2022 to May 2022 
  - Median price YoY also slightly increased in December but the increase was only 1.92%
  - Median sale price declined by around $90,000 from May to December 2022
 
- Median Days on Market is higher in January 2022 compared to January 2021 by 2 days. From February through May there was no change in median days on market between 2022 and 2021. In Deember median DOM increased by 4 days co,pared to a year ago. median DOM of 14 is the highest level in both 2022 and 2021
- Months of Inventory has been down throughout 2022; However, for the first time YoY change in months of inventory was positive in November and it continued in to December. It increased from 0.6 in December 2021 to 0.8 in December 2022.
- New Listings has been down throughout 2022 except for in February. New Listings hit the lowest level in December 2022. 
