---
title: "MD Real Estate Summary June 2022"
...
## Maryland housing Data: June 2022 


### Units Sold

```{r cars}
june_housing <- read.xls("/Users/Divy/Documents/md_housing_data/June 2022 Housing Stats.xlsx", header = TRUE, skip = 1)
...
colnames(june_housing) <- table_column_names
...
reformatted_june_housing <- reformat_housing_df(june_housing)
reformatted_june_housing$month <- "June"

maryland_fips_table <- reformatted_june_housing %>% 
...
reformatted_june_housing$units_sold_change <- (reformatted_june_housing$units_sold_2022 - reformatted_june_housing$units_sold_2021) /
  reformatted_june_housing$units_sold_2021 *100
reformatted_june_housing$units_sold_change_color <- "green"
reformatted_june_housing$units_sold_change_color[reformatted_june_housing$units_sold_change < 0] <- "red"

reformatted_june_housing$just_county_name <- gsub(' County','',reformatted_june_housing$county_name)



ggplot(aes(x = reorder(just_county_name, units_sold_change), y = units_sold_change,
           fill = units_sold_change_color), 
       data = reformatted_june_housing) + 
...
reformatted_june_housing$units_pending_change <- (reformatted_june_housing$units_pending_2022 - reformatted_june_housing$units_pending_2021) /
  reformatted_june_housing$units_pending_2021 *100
reformatted_june_housing$units_pending_change_color <- "green"
reformatted_june_housing$units_pending_change_color[reformatted_june_housing$units_pending_change < 0] <- "red"
...
```{r}
reformatted_june_housing$active_inventory_change <- (reformatted_june_housing$active_inventory_2022 - reformatted_june_housing$active_inventory_2021) /
  reformatted_june_housing$active_inventory_2021 *100
reformatted_june_housing$active_inventory_change_color <- "green"
reformatted_june_housing$active_inventory_change_color[reformatted_june_housing$active_inventory_change < 0] <- "red"
...
reformatted_june_housing$average_sale_price_change <- (reformatted_june_housing$average_sale_price_2022 - reformatted_june_housing$average_sale_price_2021) /
  reformatted_june_housing$average_sale_price_2021 *100
reformatted_june_housing$average_sale_price_change_color <- "green"
reformatted_june_housing$average_sale_price_change_color[reformatted_june_housing$average_sale_price_change < 0] <- "red"
...
```{r}
reformatted_june_housing$median_sale_price_change <- (reformatted_june_housing$median_sale_price_2022 - reformatted_june_housing$median_sale_price_2021) /
  reformatted_june_housing$median_sale_price_2021 *100
reformatted_june_housing$median_sale_price_change_color <- "green"
reformatted_june_housing$median_sale_price_change_color[reformatted_june_housing$median_sale_price_change < 0] <- "red"
...
reformatted_june_housing$median_dom_change <- (reformatted_june_housing$median_dom_2022 - reformatted_june_housing$median_dom_2021) 
reformatted_june_housing$median_dom_change_color <- "green"
reformatted_june_housing$median_dom_change_color[reformatted_june_housing$median_dom_change < 0] <- "red"
...
```{r}
reformatted_june_housing$months_of_inventory_change <- ((reformatted_june_housing$months_of_inventory_2022 - reformatted_june_housing$months_of_inventory_2021) / reformatted_june_housing$months_of_inventory_2021) * 100
reformatted_june_housing$months_of_inventory_change_color <- "green"
reformatted_june_housing$months_of_inventory_change_color[reformatted_june_housing$months_of_inventory_change < 0] <- "red"
...
```{r}
reformatted_june_housing$new_listings_change <- ((reformatted_june_housing$new_listings_2022 - reformatted_june_housing$new_listings_2021) / reformatted_june_housing$new_listings_2021) * 100
reformatted_june_housing$new_listings_change_color <- "green"
reformatted_june_housing$new_listings_change_color[reformatted_june_housing$new_listings_change < 0] <- "red"
...
- Units sold is down or the same in all but one county - Dorchester county (Chesapeake Bay Area)
...
- Average sale price is up in all counties except Dorchester County 
  - Range of % YoY Change in Average sale price is -15% to 39%
- Median sale price is up in all counties except Garrett, Allegany & Dorchester counties
  - Range of % YoY Change in Median Sale Price is - 4% to 65%
- Median days on market is down in 4/24 regions and (All in Chesapeake Region). Median DOM is up in 14/24 regions. In 6/24 regions median DOM is unchanged
  - In Allegany county YoY median DOM decreased by 5 days and in Somerset county it increased by 10 days
  
- Months of inventory is up in 6 counties and unchanged in 2 counties. In rest of the regions months of inventory is down.
  - Range of % YoY Change in Months of Inventory is -45% to 42%

- New Listings are up in 2/24 regions and in rest of the regions new listings were down
  - Range of % YoY Change in Months of Inventory is -23% to 46%

```{r, fig.width=25, fig.height=15}

reformatted_june_housing$county <- reformatted_june_housing$county_name
melted_moco_june_df <- melt(reformatted_june_housing, id.vars = c("county", "month"))

melted_moco_june_df$year <- 0
melted_moco_june_df$year[grep('2021', melted_moco_june_df$variable)] <- 2021
melted_moco_june_df$year[grep('2022',melted_moco_june_df$variable)] <- 2022

melted_moco_june_df <- melted_moco_june_df[melted_moco_june_df$county == "Montgomery County",]

melted_moco_df_jan_may <- read.table("/Users/Divy/Documents/md_housing_data/reformatted_jan_may_2022.tsv",
                                       sep = "\t", header = TRUE)

melted_moco_df_jan_june <- rbind(melted_moco_june_df, melted_moco_df_jan_may)

write.table(melted_moco_df_jan_june, "/Users/Divy/Documents/md_housing_data/reformatted_jan_june_2022.tsv", 
            sep = '\t', row.names = FALSE)
...
## Montgomery County trend: January - June 2022


### Units Sold

```{r}
melted_moco_df_units_sold <- melted_moco_df_jan_june[grep('units_sold_[0-9]', melted_moco_df_jan_june$variable),]
...
melted_moco_df_units_pending <- melted_moco_df_jan_june[grep('units_pending_[0-9]',melted_moco_df_jan_june$variable),]
...
melted_moco_df_active_inventory <- melted_moco_df_jan_june[grep('active_inventory_[0-9]',melted_moco_df_jan_june$variable),]
...
melted_moco_df_average_sale_price <- melted_moco_df_jan_june[grep('average_sale_price_[0-9]',melted_moco_df_jan_june$variable),]
...
melted_moco_df_median_sale_price <- melted_moco_df_jan_june[grep('median_sale_price_[0-9]',melted_moco_df_jan_june$variable),]
...
```{r}
melted_moco_df_median_dom <- melted_moco_df_jan_june[grep('median_dom_[0-9]',melted_moco_df_jan_june$variable),]
...
```{r}
melted_moco_df_months_of_inventory <- melted_moco_df_jan_june[grep('months_of_inventory_[0-9]',melted_moco_df_jan_june$variable),]
...
```{r}
melted_moco_df_new_listings <- melted_moco_df_jan_june[grep('new_listings_[0-9]',melted_moco_df_jan_june$variable),]
...
- Units sold is down from January through June 
  - % Change in units sold doesn't show a consistent pattern; However, we observed the largest YoY decline in units sold in June (-22.53%)  
- Units pending is also down from January through June. Since February YoY decline in units pending has been increasing and in June this decline was 24.16%
  - Difference was below 3% in February and except for that every other month YoY units pending is down more than 10%
- 2022 active inventory is also down compared to 2021 levels. However, it is improving every single month since January 2022
  - In January the YoY % difference was -50% but in April the YoY % difference was -20%
- Average sale price is lower in January 2022 compared to January 2021. 
  - For the first time since January 2022 average sale price declined in June 2022. Average sale price declined by around $ 40,000 from May to June 2022
  - Since then average sale price is higher in 2022 compared to 2021. In June YoY increase was 7.03% 
- Median sale price also showed similar trend as the average sale price; However, median sale price gradually increased every single month since February 2022. 
  - For the first time since January 2022 average sale price declined in June 2022. Median sale price declined by around $ 20,000 from May to June 2022
  - Since then median sale price is higher in 2022 compared to 2021. In June YoY increase was 7.53% 
- Median Days on Market is higher in January 2022 compared to January 2021 by 2 days. From February through May there was no change in median days on market between 2022 and 2021. However, in June median DOM increased for the first time since January by 1 day.
- Months of Inventory has been down throughout 2022; However, it has been gradually increasing since January. In January YoY change in months of inventory was -55.56% and in June it improved to -9%
- New Listings has been down throughout 2022 except for in February. YoY change in new listings are lower in June compared to May.
