---
title: "MD Real Estate Summary September 2022"
...
```{r cars}
september_housing <- read.xls("/Users/Divy/Documents/md_housing_data/September 2022 Housing Stats.xlsx", header = TRUE, skip = 1)
...
colnames(september_housing) <- table_column_names
...
reformatted_september_housing <- reformat_housing_df(september_housing)
reformatted_september_housing$month <- "September"

maryland_fips_table <- reformatted_september_housing %>% 
...
reformatted_september_housing$units_sold_change <- (reformatted_september_housing$units_sold_2022 - reformatted_september_housing$units_sold_2021) /
  reformatted_september_housing$units_sold_2021 *100
reformatted_september_housing$units_sold_change_color <- "green"
reformatted_september_housing$units_sold_change_color[reformatted_september_housing$units_sold_change < 0] <- "red"

reformatted_september_housing$just_county_name <- gsub(' County','',reformatted_september_housing$county_name)



ggplot(aes(x = reorder(just_county_name, units_sold_change), y = units_sold_change,
           fill = units_sold_change_color), 
       data = reformatted_september_housing) + 
...
reformatted_september_housing$units_pending_change <- (reformatted_september_housing$units_pending_2022 - reformatted_september_housing$units_pending_2021) /
  reformatted_september_housing$units_pending_2021 *100
reformatted_september_housing$units_pending_change_color <- "green"
reformatted_september_housing$units_pending_change_color[reformatted_september_housing$units_pending_change < 0] <- "red"
...
```{r}
reformatted_september_housing$active_inventory_change <- (reformatted_september_housing$active_inventory_2022 - reformatted_september_housing$active_inventory_2021) /
  reformatted_september_housing$active_inventory_2021 *100
reformatted_september_housing$active_inventory_change_color <- "green"
reformatted_september_housing$active_inventory_change_color[reformatted_september_housing$active_inventory_change < 0] <- "red"
...
reformatted_september_housing$average_sale_price_change <- (reformatted_september_housing$average_sale_price_2022 - reformatted_september_housing$average_sale_price_2021) /
  reformatted_september_housing$average_sale_price_2021 *100
reformatted_september_housing$average_sale_price_change_color <- "green"
reformatted_september_housing$average_sale_price_change_color[reformatted_september_housing$average_sale_price_change < 0] <- "red"
...
```{r}
reformatted_september_housing$median_sale_price_change <- (reformatted_september_housing$median_sale_price_2022 - reformatted_september_housing$median_sale_price_2021) /
  reformatted_september_housing$median_sale_price_2021 *100
reformatted_september_housing$median_sale_price_change_color <- "green"
reformatted_september_housing$median_sale_price_change_color[reformatted_september_housing$median_sale_price_change < 0] <- "red"
...
reformatted_september_housing$median_dom_change <- (reformatted_september_housing$median_dom_2022 - reformatted_september_housing$median_dom_2021) 
reformatted_september_housing$median_dom_change_color <- "green"
reformatted_september_housing$median_dom_change_color[reformatted_september_housing$median_dom_change < 0] <- "red"
...
```{r}
reformatted_september_housing$months_of_inventory_change <- ((reformatted_september_housing$months_of_inventory_2022 - reformatted_september_housing$months_of_inventory_2021) / reformatted_september_housing$months_of_inventory_2021) * 100
reformatted_september_housing$months_of_inventory_change_color <- "green"
reformatted_september_housing$months_of_inventory_change_color[reformatted_september_housing$months_of_inventory_change < 0] <- "red"
...
```{r}
reformatted_september_housing$new_listings_change <- ((reformatted_september_housing$new_listings_2022 - reformatted_september_housing$new_listings_2021) / reformatted_september_housing$new_listings_2021) * 100
reformatted_september_housing$new_listings_change_color <- "green"
reformatted_september_housing$new_listings_change_color[reformatted_september_housing$new_listings_change < 0] <- "red"
...
- Units sold is down in every county except for Allegany county
  - Range of % YoY Change in Units sold is -59% to 23.7%
- Pending Sales is down in all but two counties - Dorchester, and Somerset 
  - Range of % YoY Change in Units pending  is -40.5% to 57.1%
- Active Inventory is up in 4/24 regions
  - Range of % YoY Change in Active Inventory is -50.6% to 21.9%
- Average sale price is down in 7/24 regions 
  - Range of % YoY Change in Average Sale Price is -34.2% to 26.6%
- Median sale price is down in 6/24 regions 
  - Range of % YoY Change in Median Sale Price is -23% to 15%
- Median days on market is down in 3/24 regions and Median DOM is up in 20/24 regions. In 1/24 regions median DOM is unchanged
  - In Talbot county YoY median DOM decreased by 8 days and in Garett county it increased by 17 days
  
- Months of inventory is up in 7 counties and unchanged in 2 counties. In rest of the regions months of inventory is down or the down.
  - Range of % YoY Change in Months of Inventory is -29.4% to 45.4%

- New Listings are down in all of the regions except for Caroline, Allegany and Dorchester counties.
  - Range of % YoY Change in New Listings is -41.3% to 17.5%
  
```{r, fig.width=25, fig.height=15}

reformatted_september_housing$county <- reformatted_september_housing$county_name
melted_moco_september_df <- melt(reformatted_september_housing, id.vars = c("county", "month"))

melted_moco_september_df$year <- 0
melted_moco_september_df$year[grep('2021', melted_moco_september_df$variable)] <- 2021
melted_moco_september_df$year[grep('2022',melted_moco_september_df$variable)] <- 2022

melted_moco_september_df <- melted_moco_september_df[melted_moco_september_df$county == "Montgomery County",]

melted_moco_df_jan_august <- read.table("/Users/Divy/Documents/md_housing_data/reformatted_jan_august_2022.tsv",
                                       sep = "\t", header = TRUE)

melted_moco_df_jan_september <- rbind(melted_moco_september_df, melted_moco_df_jan_august)

write.table(melted_moco_df_jan_september, "/Users/Divy/Documents/md_housing_data/reformatted_jan_september_2022.tsv", 
            sep = '\t', row.names = FALSE)
...
## Montgomery County trend: January - September 2022


### Units Sold

```{r}
melted_moco_df_units_sold <- melted_moco_df_jan_september[grep('units_sold_[0-9]', melted_moco_df_jan_september$variable),]
...
melted_moco_df_units_pending <- melted_moco_df_jan_september[grep('units_pending_[0-9]',melted_moco_df_jan_september$variable),]
...
melted_moco_df_active_inventory <- melted_moco_df_jan_september[grep('active_inventory_[0-9]',melted_moco_df_jan_september$variable),]
...
melted_moco_df_average_sale_price <- melted_moco_df_jan_september[grep('average_sale_price_[0-9]',melted_moco_df_jan_september$variable),]
...
melted_moco_df_median_sale_price <- melted_moco_df_jan_september[grep('median_sale_price_[0-9]',melted_moco_df_jan_september$variable),]
...
```{r}
melted_moco_df_median_dom <- melted_moco_df_jan_september[grep('median_dom_[0-9]',melted_moco_df_jan_september$variable),]
...
```{r}
melted_moco_df_months_of_inventory <- melted_moco_df_jan_september[grep('months_of_inventory_[0-9]',melted_moco_df_jan_september$variable),]
...
```{r}
melted_moco_df_new_listings <- melted_moco_df_jan_september[grep('new_listings_[0-9]',melted_moco_df_jan_september$variable),]
...
- Units sold is down from January through September 
  - % Change in units sold doesn't show a consistent pattern; However, we observed the largest YoY decline in units sold in July (-30.01%)  and in September the change was -28.32%
  
- Units pending is also down from January through September. Since February YoY decline in units pending has been increasing and in September we saw the largest decline which was -32.32%
...
- 2022 active inventory is also down compared to 2021 levels. However, it improved every single month from January 2022 till June 2022. but July there was a slight decline compared to June
  - In January the YoY % difference was -50% but in September the YoY % difference was -28.22%
- Average sale price was lower in January 2022 compared to January 2021. 
  - Average sale price further decline in September 2022. Average sale price declined by $122,389 from May to September 2022. September average prices were below the average prices of March 2022
  - Average sale price is higher in 2022 compared to 2021. In August YoY increase was 4.89%
- Median sale price gradually increased every single month since February 2022 to May 2022 
  - For the fourth consecutive month median sale price declined in September 2022. Median sale price declined by around $95,000 from May to August 2022
  - In August YoY increase was only 2.94%. Second smallest increases since February 2022 
- Median Days on Market is higher in January 2022 compared to January 2021 by 2 days. From February through May there was no change in median days on market between 2022 and 2021. In July 2022 median DOM stayed the same as July 2021. Then in August 2022 median DOM increased by 1 day compared to August 2021.
Then in September 2022 median DOM increased by 3 days compared to September 2021.
- Months of Inventory has been down throughout 2022; However, it has been gradually increasing since January with a decline in August compared to July. In January YoY change in months of inventory was -55.56% and in September it improved to -15.38%
- New Listings has been down throughout 2022 except for in February. YoY change in new listings are similar in September, August and July.
