---
title: "MD Real Estate Summary August 2022"
...
```{r cars}
august_housing <- read.xls("/Users/Divy/Documents/md_housing_data/August 2022 Housing Stats.xlsx", header = TRUE, skip = 1)
...
colnames(august_housing) <- table_column_names
...
reformatted_august_housing <- reformat_housing_df(august_housing)
reformatted_august_housing$month <- "August"

maryland_fips_table <- reformatted_august_housing %>% 
...
reformatted_august_housing$units_sold_change <- (reformatted_august_housing$units_sold_2022 - reformatted_august_housing$units_sold_2021) /
  reformatted_august_housing$units_sold_2021 *100
reformatted_august_housing$units_sold_change_color <- "green"
reformatted_august_housing$units_sold_change_color[reformatted_august_housing$units_sold_change < 0] <- "red"

reformatted_august_housing$just_county_name <- gsub(' County','',reformatted_august_housing$county_name)



ggplot(aes(x = reorder(just_county_name, units_sold_change), y = units_sold_change,
           fill = units_sold_change_color), 
       data = reformatted_august_housing) + 
...
reformatted_august_housing$units_pending_change <- (reformatted_august_housing$units_pending_2022 - reformatted_august_housing$units_pending_2021) /
  reformatted_august_housing$units_pending_2021 *100
reformatted_august_housing$units_pending_change_color <- "green"
reformatted_august_housing$units_pending_change_color[reformatted_august_housing$units_pending_change < 0] <- "red"
...
```{r}
reformatted_august_housing$active_inventory_change <- (reformatted_august_housing$active_inventory_2022 - reformatted_august_housing$active_inventory_2021) /
  reformatted_august_housing$active_inventory_2021 *100
reformatted_august_housing$active_inventory_change_color <- "green"
reformatted_august_housing$active_inventory_change_color[reformatted_august_housing$active_inventory_change < 0] <- "red"
...
reformatted_august_housing$average_sale_price_change <- (reformatted_august_housing$average_sale_price_2022 - reformatted_august_housing$average_sale_price_2021) /
  reformatted_august_housing$average_sale_price_2021 *100
reformatted_august_housing$average_sale_price_change_color <- "green"
reformatted_august_housing$average_sale_price_change_color[reformatted_august_housing$average_sale_price_change < 0] <- "red"
...
```{r}
reformatted_august_housing$median_sale_price_change <- (reformatted_august_housing$median_sale_price_2022 - reformatted_august_housing$median_sale_price_2021) /
  reformatted_august_housing$median_sale_price_2021 *100
reformatted_august_housing$median_sale_price_change_color <- "green"
reformatted_august_housing$median_sale_price_change_color[reformatted_august_housing$median_sale_price_change < 0] <- "red"
...
reformatted_august_housing$median_dom_change <- (reformatted_august_housing$median_dom_2022 - reformatted_august_housing$median_dom_2021) 
reformatted_august_housing$median_dom_change_color <- "green"
reformatted_august_housing$median_dom_change_color[reformatted_august_housing$median_dom_change < 0] <- "red"
...
```{r}
reformatted_august_housing$months_of_inventory_change <- ((reformatted_august_housing$months_of_inventory_2022 - reformatted_august_housing$months_of_inventory_2021) / reformatted_august_housing$months_of_inventory_2021) * 100
reformatted_august_housing$months_of_inventory_change_color <- "green"
reformatted_august_housing$months_of_inventory_change_color[reformatted_august_housing$months_of_inventory_change < 0] <- "red"
...
```{r}
reformatted_august_housing$new_listings_change <- ((reformatted_august_housing$new_listings_2022 - reformatted_august_housing$new_listings_2021) / reformatted_august_housing$new_listings_2021) * 100
reformatted_august_housing$new_listings_change_color <- "green"
reformatted_august_housing$new_listings_change_color[reformatted_august_housing$new_listings_change < 0] <- "red"
...
- Pending Sales is down in all but three counties - Dorchester, Garett, and Allegany 
...
- Average sale price is up in all counties except Talbot, Kent, Dorchester and Caroline Counties 
  - Range of % YoY Change in Average Sale Price is -26% to 39%
- Median sale price is up in all counties except Talbot, Somerset and Dorchester counties
  - Range of % YoY Change in Median Sale Price is -23% to 51%
- Median days on market is down in 1/24 regions and Median DOM is up in 21/24 regions. In 2/24 regions median DOM is unchanged
  - In Garett county YoY median DOM decreased by 3 days and in Caroline county it increased by 13 days
  
- Months of inventory is up in 5 counties. In rest of the regions months of inventory is down or the same.
  - Range of % YoY Change in Months of Inventory is -45% to 45%

- New Listings are down in all of the regions except for Somerset county
  - Range of % YoY Change in Months of Inventory is -58% to -2%

```{r, fig.width=25, fig.height=15}

reformatted_august_housing$county <- reformatted_august_housing$county_name
melted_moco_august_df <- melt(reformatted_august_housing, id.vars = c("county", "month"))

melted_moco_august_df$year <- 0
melted_moco_august_df$year[grep('2021', melted_moco_august_df$variable)] <- 2021
melted_moco_august_df$year[grep('2022',melted_moco_august_df$variable)] <- 2022

melted_moco_august_df <- melted_moco_august_df[melted_moco_august_df$county == "Montgomery County",]

melted_moco_df_jan_june <- read.table("/Users/Divy/Documents/md_housing_data/reformatted_jan_june_2022.tsv",
                                       sep = "\t", header = TRUE)

melted_moco_df_jan_august <- rbind(melted_moco_august_df, melted_moco_df_jan_june)

write.table(melted_moco_df_jan_august, "/Users/Divy/Documents/md_housing_data/reformatted_jan_august_2022.tsv", 
            sep = '\t', row.names = FALSE)
...
```{r}
melted_moco_df_units_sold <- melted_moco_df_jan_august[grep('units_sold_[0-9]', melted_moco_df_jan_august$variable),]
...
melted_moco_df_units_pending <- melted_moco_df_jan_august[grep('units_pending_[0-9]',melted_moco_df_jan_august$variable),]
...
melted_moco_df_active_inventory <- melted_moco_df_jan_august[grep('active_inventory_[0-9]',melted_moco_df_jan_august$variable),]
...
melted_moco_df_average_sale_price <- melted_moco_df_jan_august[grep('average_sale_price_[0-9]',melted_moco_df_jan_august$variable),]
...
melted_moco_df_median_sale_price <- melted_moco_df_jan_august[grep('median_sale_price_[0-9]',melted_moco_df_jan_august$variable),]
...
```{r}
melted_moco_df_median_dom <- melted_moco_df_jan_august[grep('median_dom_[0-9]',melted_moco_df_jan_august$variable),]
...
```{r}
melted_moco_df_months_of_inventory <- melted_moco_df_jan_august[grep('months_of_inventory_[0-9]',melted_moco_df_jan_august$variable),]
...
```{r}
melted_moco_df_new_listings <- melted_moco_df_jan_august[grep('new_listings_[0-9]',melted_moco_df_jan_august$variable),]
...
melted_moco_df_jan_july <- read.table("/Users/Divy/Documents/md_housing_data/reformatted_jan_july_2022.tsv",
                                       sep = "\t", header = TRUE)

melted_moco_df_jan_august <- rbind(melted_moco_august_df, melted_moco_df_jan_july)
...
- Units sold is down from January through August 
  - % Change in units sold doesn't show a consistent pattern; However, we observed the largest YoY decline in units sold in July (-30.01%)  and in August the change was -27.19%
  
- Units pending is also down from January through August. Since February YoY decline in units pending has been increasing and in July this decline was 24.74%. In August pending sales increased but still down YoY by 22.51%
...
- 2022 active inventory is also down compared to 2021 levels. However, it improved every single month from January 2022 till June 2022. but July there was a slight decline compared to June
  - In January the YoY % difference was -50% but in August the YoY % difference was -33.25%
- Average sale price was lower in January 2022 compared to January 2021. 
  -  Average sale price slightly increased in August 2022 from July 2022. Average sale price declined by around $58,547 from May to August 2022
  - Average sale price is higher in 2022 compared to 2021. In August YoY increase was 7.02%
  
 
- Median sale price gradually increased every single month since February 2022 to May 2022 
  - For the third consecutive month median sale price declined in August 2022. Median sale price declined by around $53,000 from May to August 2022
  - In August YoY increase was only 2.16%. Smallest increases since February 2022 
...
- Months of Inventory has been down throughout 2022; However, it has been gradually increasing since January with a decline in August compared to July. In January YoY change in months of inventory was -55.56% and in August it improved to -23.08%
- New Listings has been down throughout 2022 except for in February. YoY change in new listings are lower in August compared to July.
