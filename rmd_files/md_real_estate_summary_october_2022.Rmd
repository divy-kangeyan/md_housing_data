...
```{r cars}
october_housing <- read.xls("/Users/Divy/Documents/md_housing_data/excel_files/October 2022 Housing Stats.xlsx", header = TRUE, skip = 1)
...
colnames(october_housing) <- table_column_names
...
reformatted_october_housing <- reformat_housing_df(october_housing)
reformatted_october_housing$month <- "October"

maryland_fips_table <- reformatted_october_housing %>% 
...
reformatted_october_housing$units_sold_change <- (reformatted_october_housing$units_sold_2022 - reformatted_october_housing$units_sold_2021) /
  reformatted_october_housing$units_sold_2021 *100
reformatted_october_housing$units_sold_change_color <- "green"
reformatted_october_housing$units_sold_change_color[reformatted_october_housing$units_sold_change < 0] <- "red"

reformatted_october_housing$just_county_name <- gsub(' County','',reformatted_october_housing$county_name)



ggplot(aes(x = reorder(just_county_name, units_sold_change), y = units_sold_change,
           fill = units_sold_change_color), 
       data = reformatted_october_housing) + 
...
reformatted_october_housing$units_pending_change <- (reformatted_october_housing$units_pending_2022 - reformatted_october_housing$units_pending_2021) /
  reformatted_october_housing$units_pending_2021 *100
reformatted_october_housing$units_pending_change_color <- "green"
reformatted_october_housing$units_pending_change_color[reformatted_october_housing$units_pending_change < 0] <- "red"
...
```{r}
reformatted_october_housing$active_inventory_change <- (reformatted_october_housing$active_inventory_2022 - reformatted_october_housing$active_inventory_2021) /
  reformatted_october_housing$active_inventory_2021 *100
reformatted_october_housing$active_inventory_change_color <- "green"
reformatted_october_housing$active_inventory_change_color[reformatted_october_housing$active_inventory_change < 0] <- "red"
...
reformatted_october_housing$average_sale_price_change <- (reformatted_october_housing$average_sale_price_2022 - reformatted_october_housing$average_sale_price_2021) /
  reformatted_october_housing$average_sale_price_2021 *100
reformatted_october_housing$average_sale_price_change_color <- "green"
reformatted_october_housing$average_sale_price_change_color[reformatted_october_housing$average_sale_price_change < 0] <- "red"
...
```{r}
reformatted_october_housing$median_sale_price_change <- (reformatted_october_housing$median_sale_price_2022 - reformatted_october_housing$median_sale_price_2021) /
  reformatted_october_housing$median_sale_price_2021 *100
reformatted_october_housing$median_sale_price_change_color <- "green"
reformatted_october_housing$median_sale_price_change_color[reformatted_october_housing$median_sale_price_change < 0] <- "red"
...
reformatted_october_housing$median_dom_change <- (reformatted_october_housing$median_dom_2022 - reformatted_october_housing$median_dom_2021) 
reformatted_october_housing$median_dom_change_color <- "green"
reformatted_october_housing$median_dom_change_color[reformatted_october_housing$median_dom_change < 0] <- "red"
...
```{r}
reformatted_october_housing$months_of_inventory_change <- ((reformatted_october_housing$months_of_inventory_2022 - reformatted_october_housing$months_of_inventory_2021) / reformatted_october_housing$months_of_inventory_2021) * 100
reformatted_october_housing$months_of_inventory_change_color <- "green"
reformatted_october_housing$months_of_inventory_change_color[reformatted_october_housing$months_of_inventory_change < 0] <- "red"
...
```{r}
reformatted_october_housing$new_listings_change <- ((reformatted_october_housing$new_listings_2022 - reformatted_october_housing$new_listings_2021) / reformatted_october_housing$new_listings_2021) * 100
reformatted_october_housing$new_listings_change_color <- "green"
reformatted_october_housing$new_listings_change_color[reformatted_october_housing$new_listings_change < 0] <- "red"
...
reformatted_october_housing$county <- reformatted_october_housing$county_name
melted_moco_october_df <- melt(reformatted_october_housing, id.vars = c("county", "month"))

melted_moco_october_df$year <- 0
melted_moco_october_df$year[grep('2021', melted_moco_october_df$variable)] <- 2021
melted_moco_october_df$year[grep('2022',melted_moco_october_df$variable)] <- 2022

melted_moco_october_df <- melted_moco_october_df[melted_moco_october_df$county == "Montgomery County",]
...
melted_moco_df_jan_october <- rbind(melted_moco_october_df, melted_moco_df_jan_september)

write.table(melted_moco_df_jan_october, "/Users/Divy/Documents/md_housing_data/reformatted_jan_october_2022.tsv", 
            sep = '\t', row.names = FALSE)
...
```{r}
melted_moco_df_units_sold <- melted_moco_df_jan_october[grep('units_sold_[0-9]', melted_moco_df_jan_october$variable),]
...
melted_moco_df_units_pending <- melted_moco_df_jan_october[grep('units_pending_[0-9]',melted_moco_df_jan_october$variable),]
...
melted_moco_df_active_inventory <- melted_moco_df_jan_october[grep('active_inventory_[0-9]',melted_moco_df_jan_october$variable),]
...
melted_moco_df_average_sale_price <- melted_moco_df_jan_october[grep('average_sale_price_[0-9]',melted_moco_df_jan_october$variable),]
...
melted_moco_df_median_sale_price <- melted_moco_df_jan_october[grep('median_sale_price_[0-9]',melted_moco_df_jan_october$variable),]
...
```{r}
melted_moco_df_median_dom <- melted_moco_df_jan_october[grep('median_dom_[0-9]',melted_moco_df_jan_october$variable),]
...
```{r}
melted_moco_df_months_of_inventory <- melted_moco_df_jan_october[grep('months_of_inventory_[0-9]',melted_moco_df_jan_october$variable),]
...
```{r}
melted_moco_df_new_listings <- melted_moco_df_jan_october[grep('new_listings_[0-9]',melted_moco_df_jan_october$variable),]
...
- Units sold is down from January through October 
  - October showed the largest decline in units sold at - 38.13%. Units sold has been negative throughout
